...
function! lsp_cxx_hl#notify_symbols(server, buffer, symbols) abort
    ...
    call lsp_cxx_hl_cache#notify_symbols((a:server ==# 'ccls'),
                \ l:bufnr, a:symbols)
endfunction

" Receive already extracted symbol data
function! lsp_cxx_hl#notify_symbols_aux(is_ccls, bufnr, symbols) abort
    try
        let l:begintime = lsp_cxx_hl#profile_begin()
        ...
        call lsp_cxx_hl#hl#notify_symbols(a:bufnr, l:n_symbols)
