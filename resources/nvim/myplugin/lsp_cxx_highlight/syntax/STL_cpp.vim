...
if !exists('g:cpp_no_function_highlight')
    ...
    hi def link cCustomFunc  LspCxxHlSymFunction
endif
...
if version >= 508 || !exists("did_cpp_syntax_inits")
  ...
  HiLink cppSTLnamespace    LspCxxHlSymNamespace
  HiLink cppSTLtype         LspCxxHlType
  HiLink cppSTLexception    LspCxxHlType
  HiLink cppSTLiterator     LspCxxHlType
  HiLink cppSTLiterator_tag LspCxxHlType
  HiLink cppSTLenum         LspCxxHlType
  HiLink cppSTLconcept      LspCxxHlType
  HiLink cppSTLios          LspCxxHlSymFunction
  HiLink cppSTLcast         None " be consistent with official syntax
  HiLink cppRawString       LspCxxHlLiterals
  HiLink cppRawDelimiter    Delimiter
  HiLink cppStructure    LspCxxHlKeyword
