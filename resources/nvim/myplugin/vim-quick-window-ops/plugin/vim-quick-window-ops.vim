...
call s:MapGenerate('g:QuickOperationWindow_LeftMoveLabel',  '<plug>(qwo-move-label-left)')
call s:MapGenerate('g:QuickOperationWindow_RightMoveLabel', '<plug>(qwo-move-label-right)')
call s:MapGenerate('g:QuickOperationWindow_LeftDelLabel',   '<plug>(qwo-remove-label-left)')
call s:MapGenerate('g:QuickOperationWindow_RightDelLabel',  '<plug>(qwo-remove-label-right)')
call s:MapGenerate('g:QuickOperationWindow_LoopMoveLabel',  '<plug>(qwo-move-label-right)')
call s:MapGenerate('g:QuickOperationWindow_UpOpenWindow',   '<plug>(qwo-window-up)')
call s:MapGenerate('g:QuickOperationWindow_DownOpenWindow', '<plug>(qwo-window-down)')
call s:MapGenerate('g:QuickOperationWindow_LeftOpenWindow', '<plug>(qwo-window-left)')
call s:MapGenerate('g:QuickOperationWindow_RightOpenWindow','<plug>(qwo-window-right)')
call s:MapGenerate('g:QuickOperationWindow_CloseCurrentWindow','<plug>(qwo-window-close)')
